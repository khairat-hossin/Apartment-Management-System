...
class EmployeeManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
       // $this->validateInput($request);
        ...
        $keys = ['lastname', 'firstname', 'middlename','nickname','fathername','mothername', 'address', 'city_id', 'state_id', 'country_id', 'zip','phone', 'age', 'birthdate', 'date_hired','refname', 'refcontact','verification','nid','emergencyname', 'emergencycontact',];
    ...
    public function edit($id)
    {
        ...
        // Redirect to state list if updating state wasn't existed  || count($employee) == 0
        if ($employee == null) {
            return redirect()->intended('/employee-management');
        }
        $cities = City::all();
       ...
       public function show($id)
    {
        ...
        $departments = Department::all();
        $divisions = Division::all();
        return view('employees-mgmt/show', ['employee' => $employee, 'cities' => $cities, 'states' => $states, 'countries' => $countries]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validateInput($request);
        // Upload image
        $keys = ['lastname', 'firstname', 'middlename', 'address', 'city_id', 'state_id', 'country_id', 'zip', 'age', 'birthdate', 'date_hired', 'department_id', 'department_id', 'division_id'];
        $input = $this->createQueryInput($keys, $request);
