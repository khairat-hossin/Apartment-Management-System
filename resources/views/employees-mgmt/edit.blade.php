                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $employee->birthdate }}" name="birthdate" class="form-control pull-right datepicker" id="birthDate" required>
                                </div>
                            </div>
                        </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $employee->date_hired }}" name="date_hired" class="form-control pull-right datepicker" id="hiredDate" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
